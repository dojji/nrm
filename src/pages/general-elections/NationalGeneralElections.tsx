...
const NationalGeneralElections = () => {
  ...
  // Fetch candidates with filtering for national level
    ...
    <Box sx={{ p: 2 }}>
      ...
      <Paper sx={{ p: 2, mb: 3, bgcolor: "#f8f9fa" }}>
        <Typography variant="body1">
          Manage general election candidates and their opposition at the National level.
          You can record votes for NRM candidates, add opposition candidates, and record their votes as well.
          This includes Presidential and other national-level positions.
        </Typography>
      </Paper>
...
export default NationalGeneralElections;
