...
const VillageCellGeneralElections = () => {
  ...
  // Fetch candidates with filtering for village/cell level
  ...
  return (
    <Box sx={{ p: 2 }}>
      <Typography variant="h4" gutterBottom>
        Village/Cell General Elections
      </Typography>
      
      <Paper sx={{ p: 2, mb: 3, bgcolor: "#f8f9fa" }}>
        <Typography variant="body1">
          Manage general election candidates and their opposition at the Village/Cell level.
...
export default VillageCellGeneralElections;
